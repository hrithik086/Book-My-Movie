...
public class UserServiceImplTest {
	...
	public void getUserRoleTest() {
		userList.add(myUser);
		String returnedRole=userService.getUserRole("username", "password");
		assertEquals("admin",returnedRole);
	}

	@Test
	public void getUserByUsername() {
		userList.add(new User());
		boolean returnedValue=userService.getUserByUsername("username");
		assertEquals(true, returnedValue);
	}
